...
function getArtistByIndex(artist, num) {
  ...
  return "the artist at index " + num + " is " + result.name;
}
...
function addArtist(array) {
  ...
  return array; // I'm wondering now if I took these directions too literally...
}
...
// something new for testing the new git workflow
